...
<style type="text/css">
    ...
    <div style="margin-top:140px">
        <a href="/cases" style="padding-left:45px;color:#000;" class="back-btn">
          <i class="fa fa-arrow-left" aria-hidden="true"></i> Back
        </a>
        <h1 class="text-center">Case Details</h1>
        @if($userType == "lawyer")
        <div class="text-right accept-decline-btn">
          <a href="{{ route('case.updateStatus', ['case_id' => $case->id, 'status' => 'Accepted']) }}" class="btn btn-success accept">Accept</a>
          <a href="{{ route('case.updateStatus', ['case_id' => $case->id, 'status' => 'Declined']) }}" class="btn btn-danger">Decline</a>
        </div>
        @endif
        <br>
        <div class="container">
      ...
      ?>
             ...
             <br>
              <h2 class=" text-bold m-0 font-weight-normal">Case Related Documents<span class="float-right"></span><a class="btn btn-primary btn-lg float-md-right " href="#" data-toggle="modal" data-target="#upload_documents">Upload Documents</a></h2>
              <br>
    ...
    <div class="modal" id="upload_documents">
      <div class="modal-dialog">
        <div class="modal-content">
