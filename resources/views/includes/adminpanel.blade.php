        ...
        <div
            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="/admin/content-management" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                    ...
                    <div class="dropdown-menu dropdown-menu-right"style="text-align:center" aria-labelledby="navbarDropdown">
                        ...
                        <a class=" nav-link dropdown-item" href="/admin/content-management">
                          Landing page
                        </a>
                        </div>
                        <div class="btn-group d-flex justify-content-center" role="group" aria-label="....">
                        <a class=" nav-link dropdown-item" href="/admin/blogs">
                          Blogs page
                        </a>
                        </div>
                    </div>
