...
<style type="text/css">
      ...
      <main class="page service-page" style="margin-top:80px">
              ...
              <a href="/cases">
                <div class="card">
                  <div class="card-body" style="text-align:center !important">
                    <p class="card-title text-md-center" style="font-size:25px; color:#000;" >Cases</p>
                    <div class="d-flex flex-wrap justify-content-between justify-content-md-center  align-items-center">
                      <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0" style="color:#000;"> {{$caseCount}}</h3> 
                        ...
                        <div class="product-specs" style="font-size:1.1rem; padding-left:3rem;    color:black ">
                          ...
                          <form>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    <label for="colFormLabel" class="col-sm-3 col-form-label">Case Number</label>
                                    <div class="col-sm-9">
                                      <input type="Filing Number" class="form-control" id="colFormLabel" value="{{$item->case_no}}" disabled>
                                    </div>
                                  </div>
                                  <div class="form-group row">
