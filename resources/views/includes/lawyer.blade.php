...
$caseCount = CaseTable::where('lawyer_id',$userId)->where('status','Accepted')->count();
    ...
    <div class="container" >
      ...
      <div class="row">
        <div class="col-md-3 ">
          ...
          <div class="card">
            <div class="card-body" style="text-align:center !important">
              <p class="card-title text-md-center" style="font-size:16px; color:#000;" >Cases Accepted</p>
        ...
        <div class="col-md-3 ">
          <div class="card">
            <div class="card-body"style="text-align:center !important">
              <p class="card-title text-md-center" style="font-size:16px">Success Rate</p>
              <div class="d-flex flex-wrap justify-content-between justify-content-md-center  align-items-center">
        ...
        <div class="col-md-3 ">
          <div class="card">
            <div class="card-body"style="text-align:center !important">
              <p class="card-title " style="font-size:16px">Fees Generated</p>
              <div class="d-flex flex-wrap justify-content-between justify-content-md-center  align-items-center">
